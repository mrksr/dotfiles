...
godlike.audio.mute    = godlike.audio.mute     or function() godlike.sexec("amixer set Master toggle") end
godlike.audio.micmute = godlike.audio.micmute  or function() godlike.sexec("amixer set Capture toggle") end
